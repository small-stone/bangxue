...
export function BookIcon(props: Props) {
  return <Icon size={props.size} d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z" />
}

export function MessageIcon(props: Props) {
  return <Icon size={props.size} d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
}
...
/** Centered user mark for amber avatar wells (white stroke, optical center). */
export function ProfileUserMark({ size = 24 }: Props) {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={{ display: 'block' }}
    >
      <circle cx="12" cy="9" r="3.25" stroke="#ffffff" strokeWidth="2" />
      <path
        d="M7 18.25c.95-2.1 2.7-3.25 5-3.25s4.05 1.15 5 3.25"
        stroke="#ffffff"
        strokeWidth="2"
        strokeLinecap="round"
      />
...
export function CrossIcon({ size = 18 }: Props) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" aria-hidden="true">
...
export function ImageIcon({ size = 18 }: Props) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
...
export function CalcIcon({ size = 16 }: Props) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
...
export function SparkIcon({ size = 16 }: Props) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
